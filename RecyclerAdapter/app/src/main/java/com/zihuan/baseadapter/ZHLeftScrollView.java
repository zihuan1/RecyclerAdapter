...
/****
 */
public class ZHLeftScrollView extends HorizontalScrollView {


    public ZHLeftScrollView(Context context) {
        super(context);
        init(context, null);
    }

    public ZHLeftScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ZHLeftScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public static final String TAG = ZHLeftScrollView.class.getSimpleName();
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ZHLeftScrollView);
        rightLayoutWidth = dp2px(context, typedArray.getInteger(R.styleable.ZHLeftScrollView_right_width, 0));
        int ran = typedArray.getInteger(R.styleable.ZHLeftScrollView_move_range, 0);
        range = ran == 0 ? rightLayoutWidth / 2 : dp2px(context, ran);
        margin = dp2px(context, typedArray.getInteger(R.styleable.ZHLeftScrollView_zh_margin, 0));
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (scrollx > range) {
//                    isLeft = false;
                    ZHLeftScrollViewHelper.getInstance().setLastView(this);
